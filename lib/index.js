...
const mergeParams = (pathObj, opsObj) => {
    // Common parameters - A list of parameters that are applicable for all the operations
    // described under this path. These parameters can be overridden at the operation level,
